 ...
 */
final class Version20211109142055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE message_seq1 INCREMENT BY 100 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE message_seq2 INCREMENT BY 100 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE message_seq3 INCREMENT BY 100 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE message_seq4 INCREMENT BY 100 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE message_seq5 INCREMENT BY 100 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE message_seq6 INCREMENT BY 100 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE message_seq7 INCREMENT BY 100 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE message_seq8 INCREMENT BY 100 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE message_seq9 INCREMENT BY 100 MINVALUE 1 START 1');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE message_seq1 CASCADE');
        $this->addSql('DROP SEQUENCE message_seq2 CASCADE');
        $this->addSql('DROP SEQUENCE message_seq3 CASCADE');
        $this->addSql('DROP SEQUENCE message_seq4 CASCADE');
        $this->addSql('DROP SEQUENCE message_seq5 CASCADE');
        $this->addSql('DROP SEQUENCE message_seq6 CASCADE');
        $this->addSql('DROP SEQUENCE message_seq7 CASCADE');
        $this->addSql('DROP SEQUENCE message_seq8 CASCADE');
        $this->addSql('DROP SEQUENCE message_seq9 CASCADE');
